        ...
        <div class="box" @click="setting">
            ...
            <div class="weather-box" v-if="now">
                <div class="weather-card">
                    ...
                    <!-- <div class="icon">{{  }}</div> -->
                    <div class="right">
                        <div class="tem">{{ now.tem }}<span class="unit">℃</span></div>
                        <div class="weather">{{ location }}&nbsp;&nbsp;&nbsp;{{ now.weather }}&nbsp;&nbsp;&nbsp;相对湿度 {{ now.humidity }} %</div>
                    </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            init() {
                this.location = this.$storage.get('location', '广州')
                // this.getMyIp()
                this.getWeather(this.location)
